...
class ChessClub:
    ...
    def __init__(self, filepath=None, name=None):
        """The constructor works in two ways: - if the filepath is provided,
        it loads data from JSON - if it is not but a name is provided,
        ...
        if filepath and not name:
            ...
            # We did not have a file, so we are going to create it by
